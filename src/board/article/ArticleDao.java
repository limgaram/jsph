...
public class ArticleDao {
	...
	public ArrayList<Article> getArticlesForPaging(Pagination pagination) {
		...
		String sql = "SELECT a.*, m.nickname nickname, COUNT(l.aid) likeCnt FROM article a INNER JOIN `member` m ON a.mid = m.id LEFT JOIN `like` l ON a.id = l.aid GROUP BY a.id limit "
